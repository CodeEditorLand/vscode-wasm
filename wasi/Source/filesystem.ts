...
export namespace filesystem {
	export namespace Types.$ {
		...
		export const NewTimestamp = new $wcm.VariantType<
			...
			filesystem.Types.NewTimestamp._vt
		>(
			[
				["noChange", undefined],
				["now", undefined],
		...
		Descriptor.addMethod(
			"readViaStream",
			new $wcm.MethodType<
				filesystem.Types.Descriptor.Interface["readViaStream"]
			>(
				"[method]descriptor.read-via-stream",
				[["offset", Filesize]],
				new $wcm.ResultType<
					filesystem.Types.InputStream,
					filesystem.Types.ErrorCode
				>(
					new $wcm.OwnType<filesystem.Types.InputStream>(InputStream),
					ErrorCode,
					filesystem.Types.ErrorCode.Error_,
				),
			),
		);
		Descriptor.addMethod(
			"writeViaStream",
			new $wcm.MethodType<
				filesystem.Types.Descriptor.Interface["writeViaStream"]
			>(
				"[method]descriptor.write-via-stream",
				[["offset", Filesize]],
				new $wcm.ResultType<
					filesystem.Types.OutputStream,
					filesystem.Types.ErrorCode
				>(
					new $wcm.OwnType<filesystem.Types.OutputStream>(
						OutputStream,
					),
					ErrorCode,
					filesystem.Types.ErrorCode.Error_,
		...
		Descriptor.addMethod(
			"appendViaStream",
			new $wcm.MethodType<
				filesystem.Types.Descriptor.Interface["appendViaStream"]
			>(
		...
		Descriptor.addMethod(
			"advise",
			new $wcm.MethodType<
				filesystem.Types.Descriptor.Interface["advise"]
			>(
				...
				new $wcm.ResultType<void, filesystem.Types.ErrorCode>(
					undefined,
					ErrorCode,
					filesystem.Types.ErrorCode.Error_,
				),
		...
		Descriptor.addMethod(
			"syncData",
			new $wcm.MethodType<
				filesystem.Types.Descriptor.Interface["syncData"]
			>(
		...
		Descriptor.addMethod(
			"getFlags",
			new $wcm.MethodType<
				filesystem.Types.Descriptor.Interface["getFlags"]
			>(
				"[method]descriptor.get-flags",
				[],
				new $wcm.ResultType<
					filesystem.Types.DescriptorFlags,
					filesystem.Types.ErrorCode
				>(
					DescriptorFlags,
					ErrorCode,
		...
		Descriptor.addMethod(
			"getType",
			new $wcm.MethodType<
				filesystem.Types.Descriptor.Interface["getType"]
			>(
				"[method]descriptor.get-type",
				[],
				new $wcm.ResultType<
					filesystem.Types.DescriptorType,
					filesystem.Types.ErrorCode
		...
		Descriptor.addMethod(
			"setSize",
			new $wcm.MethodType<
				filesystem.Types.Descriptor.Interface["setSize"]
			>(
		...
		Descriptor.addMethod(
			"setTimes",
			new $wcm.MethodType<
				filesystem.Types.Descriptor.Interface["setTimes"]
			>(
		...
		Descriptor.addMethod(
			...
			new $wcm.MethodType<filesystem.Types.Descriptor.Interface["read"]>(
				...
				new $wcm.ResultType<
					...
					filesystem.Types.ErrorCode
				>(
					new $wcm.TupleType<[Uint8Array, boolean]>([
		...
		Descriptor.addMethod(
			"readDirectory",
			new $wcm.MethodType<
				filesystem.Types.Descriptor.Interface["readDirectory"]
			>(
				"[method]descriptor.read-directory",
				[],
				new $wcm.ResultType<
					filesystem.Types.DirectoryEntryStream,
					filesystem.Types.ErrorCode
				>(
					new $wcm.OwnType<filesystem.Types.DirectoryEntryStream>(
		...
		Descriptor.addMethod(
			"createDirectoryAt",
			new $wcm.MethodType<
				filesystem.Types.Descriptor.Interface["createDirectoryAt"]
			>(
		...
		Descriptor.addMethod(
			"statAt",
			new $wcm.MethodType<
				filesystem.Types.Descriptor.Interface["statAt"]
			>(
		...
		Descriptor.addMethod(
			"setTimesAt",
			new $wcm.MethodType<
				filesystem.Types.Descriptor.Interface["setTimesAt"]
			>(
		...
		Descriptor.addMethod(
			"linkAt",
			new $wcm.MethodType<
				filesystem.Types.Descriptor.Interface["linkAt"]
			>(
				...
				[
					...
					[
						"newDescriptor",
						new $wcm.BorrowType<filesystem.Types.Descriptor>(
							Descriptor,
						),
					],
					["newPath", $wcm.wstring],
		...
		Descriptor.addMethod(
			"openAt",
			new $wcm.MethodType<
				filesystem.Types.Descriptor.Interface["openAt"]
			>(
				...
				new $wcm.ResultType<
					...
					filesystem.Types.ErrorCode
				>(
					new $wcm.OwnType<filesystem.Types.Descriptor>(Descriptor),
					ErrorCode,
					filesystem.Types.ErrorCode.Error_,
				),
			),
		...
		Descriptor.addMethod(
			"readlinkAt",
			new $wcm.MethodType<
				filesystem.Types.Descriptor.Interface["readlinkAt"]
			>(
				"[method]descriptor.readlink-at",
				[["path", $wcm.wstring]],
				new $wcm.ResultType<string, filesystem.Types.ErrorCode>(
					$wcm.wstring,
					ErrorCode,
					filesystem.Types.ErrorCode.Error_,
				),
		...
		Descriptor.addMethod(
			"removeDirectoryAt",
			new $wcm.MethodType<
				filesystem.Types.Descriptor.Interface["removeDirectoryAt"]
			>(
		...
		Descriptor.addMethod(
			"renameAt",
			new $wcm.MethodType<
				filesystem.Types.Descriptor.Interface["renameAt"]
			>(
		...
		Descriptor.addMethod(
			"symlinkAt",
			new $wcm.MethodType<
				filesystem.Types.Descriptor.Interface["symlinkAt"]
			>(
		...
		Descriptor.addMethod(
			"unlinkFileAt",
			new $wcm.MethodType<
				filesystem.Types.Descriptor.Interface["unlinkFileAt"]
			>(
		...
		Descriptor.addMethod(
			"isSameObject",
			new $wcm.MethodType<
				filesystem.Types.Descriptor.Interface["isSameObject"]
			>(
		...
		Descriptor.addMethod(
			"metadataHash",
			new $wcm.MethodType<
				filesystem.Types.Descriptor.Interface["metadataHash"]
			>(
				"[method]descriptor.metadata-hash",
				[],
				new $wcm.ResultType<
					filesystem.Types.MetadataHashValue,
					filesystem.Types.ErrorCode
				>(
					MetadataHashValue,
					ErrorCode,
		...
		Descriptor.addMethod(
			"metadataHashAt",
			new $wcm.MethodType<
				filesystem.Types.Descriptor.Interface["metadataHashAt"]
			>(
		...
		DirectoryEntryStream.addMethod(
			"readDirectoryEntry",
			new $wcm.MethodType<
				filesystem.Types.DirectoryEntryStream.Interface["readDirectoryEntry"]
			>(
				"[method]directory-entry-stream.read-directory-entry",
				[],
				new $wcm.ResultType<
					filesystem.Types.DirectoryEntry | undefined,
					filesystem.Types.ErrorCode
				>(
					new $wcm.OptionType<filesystem.Types.DirectoryEntry>(
						DirectoryEntry,
					),
					ErrorCode,
					filesystem.Types.ErrorCode.Error_,
	...
	export namespace Types._ {
		...
		export namespace Descriptor {
			export type WasmInterface = {
				"[method]descriptor.read-via-stream": (
					self: i32,
					offset: i64,
					result: ptr<result<InputStream, ErrorCode>>,
				) => void;
				"[method]descriptor.write-via-stream": (
					self: i32,
					offset: i64,
					result: ptr<result<OutputStream, ErrorCode>>,
				) => void;
				"[method]descriptor.append-via-stream": (
					self: i32,
					result: ptr<result<OutputStream, ErrorCode>>,
				...
				"[method]descriptor.get-flags": (
					self: i32,
					result: ptr<result<DescriptorFlags, ErrorCode>>,
				) => void;
				"[method]descriptor.get-type": (
					self: i32,
					result: ptr<result<DescriptorType, ErrorCode>>,
				) => void;
				"[method]descriptor.set-size": (
					self: i32,
					size: i64,
				...
				"[method]descriptor.set-times": (
					self: i32,
					dataAccessTimestamp_case: i32,
					dataAccessTimestamp_0: i64,
					dataAccessTimestamp_1: i32,
					dataModificationTimestamp_case: i32,
					dataModificationTimestamp_0: i64,
					dataModificationTimestamp_1: i32,
					result: ptr<result<void, ErrorCode>>,
				) => void;
				"[method]descriptor.read": (
					self: i32,
					length: i64,
					offset: i64,
					result: ptr<result<[Uint8Array, boolean], ErrorCode>>,
				) => void;
				"[method]descriptor.write": (
					self: i32,
					buffer_ptr: i32,
					buffer_len: i32,
					offset: i64,
					result: ptr<result<Filesize, ErrorCode>>,
				) => void;
				"[method]descriptor.read-directory": (
					self: i32,
					result: ptr<result<DirectoryEntryStream, ErrorCode>>,
				) => void;
				"[method]descriptor.sync": (
					self: i32,
					result: ptr<result<void, ErrorCode>>,
				...
				"[method]descriptor.stat": (
					self: i32,
					result: ptr<result<DescriptorStat, ErrorCode>>,
				) => void;
				"[method]descriptor.stat-at": (
					self: i32,
					pathFlags: i32,
				...
				"[method]descriptor.open-at": (
					...
					openFlags: i32,
					flags: i32,
					result: ptr<result<Descriptor, ErrorCode>>,
				) => void;
				"[method]descriptor.readlink-at": (
					self: i32,
					path_ptr: i32,
					path_len: i32,
					result: ptr<result<string, ErrorCode>>,
				) => void;
				"[method]descriptor.remove-directory-at": (
					self: i32,
					path_ptr: i32,
		...
		export namespace DirectoryEntryStream {
			...
			export namespace exports {
				export type WasmInterface =
					DirectoryEntryStream.WasmInterface & {
						"[dtor]directory-entry-stream": (self: i32) => void;
					};
			}
		}
		...
		export namespace exports {
			...
			export namespace imports {
				export type WasmInterface = {
					...
					"[resource-rep]directory-entry-stream": (
						handle: i32,
					) => i32;
					"[resource-drop]directory-entry-stream": (
						handle: i32,
	...
	export namespace Preopens.$ {
		...
		export const getDirectories =
			new $wcm.FunctionType<filesystem.Preopens.getDirectories>(
				"get-directories",
				[],
				new $wcm.ListType<[filesystem.Preopens.Descriptor, string]>(
					new $wcm.TupleType<
						[filesystem.Preopens.Descriptor, string]
					>([
						new $wcm.OwnType<filesystem.Preopens.Descriptor>(
							Descriptor,
						),
						$wcm.wstring,
					]),
