...
export namespace io {
	export namespace Error.$ {
		export const Error = new $wcm.ResourceType<io.Error.Error>(
			"error",
	...
	export namespace Poll.$ {
		export const Pollable = new $wcm.ResourceType<io.Poll.Pollable>(
			"pollable",
		...
		export const poll = new $wcm.FunctionType<io.Poll.poll>(
			...
			[
				[
					"in_",
					new $wcm.ListType<io.Poll.Pollable>(
						new $wcm.BorrowType<io.Poll.Pollable>(Pollable),
					),
				],
			],
	...
	export namespace Streams.$ {
		...
		export const StreamError = new $wcm.VariantType<
			...
			io.Streams.StreamError._vt
		>(
			[
				[
					"lastOperationFailed",
					new $wcm.OwnType<io.Streams.Error>(Error),
				],
				["closed", undefined],
			],
		...
		InputStream.addMethod(
			...
			new $wcm.MethodType<io.Streams.InputStream.Interface["read"]>(
				...
				[["len", $wcm.u64]],
				new $wcm.ResultType<Uint8Array, io.Streams.StreamError>(
					new $wcm.Uint8ArrayType(),
					StreamError,
					io.Streams.StreamError.Error_,
				),
			),
		);
		...
		InputStream.addMethod(
			"blockingRead",
			new $wcm.MethodType<
				io.Streams.InputStream.Interface["blockingRead"]
			>(
		...
		InputStream.addMethod(
			...
			new $wcm.MethodType<io.Streams.InputStream.Interface["skip"]>(
				...
				[["len", $wcm.u64]],
				new $wcm.ResultType<u64, io.Streams.StreamError>(
					$wcm.u64,
					StreamError,
					io.Streams.StreamError.Error_,
				),
		...
		InputStream.addMethod(
			"blockingSkip",
			new $wcm.MethodType<
				io.Streams.InputStream.Interface["blockingSkip"]
			>(
		...
		OutputStream.addMethod(
			"checkWrite",
			new $wcm.MethodType<
				io.Streams.OutputStream.Interface["checkWrite"]
			>(
		...
		OutputStream.addMethod(
			...
			new $wcm.MethodType<io.Streams.OutputStream.Interface["write"]>(
				...
				new $wcm.ResultType<void, io.Streams.StreamError>(
					undefined,
					StreamError,
					io.Streams.StreamError.Error_,
				),
		...
		OutputStream.addMethod(
			...
			new $wcm.MethodType<
				io.Streams.OutputStream.Interface["blockingWriteAndFlush"]
			>(
		...
		OutputStream.addMethod(
			"blockingFlush",
			new $wcm.MethodType<
				io.Streams.OutputStream.Interface["blockingFlush"]
			>(
		...
		OutputStream.addMethod(
			"writeZeroes",
			new $wcm.MethodType<
				io.Streams.OutputStream.Interface["writeZeroes"]
			>(
		...
		OutputStream.addMethod(
			...
			new $wcm.MethodType<
				io.Streams.OutputStream.Interface["blockingWriteZeroesAndFlush"]
			>(
		...
		OutputStream.addMethod(
			...
			new $wcm.MethodType<io.Streams.OutputStream.Interface["splice"]>(
				...
				[
					[
						"src",
						new $wcm.BorrowType<io.Streams.InputStream>(
							InputStream,
						),
					],
					["len", $wcm.u64],
		...
		OutputStream.addMethod(
			"blockingSplice",
			new $wcm.MethodType<
				io.Streams.OutputStream.Interface["blockingSplice"]
			>(
		...
		export namespace InputStream {
			export type WasmInterface = {
				"[method]input-stream.read": (
					self: i32,
					len: i64,
					result: ptr<result<Uint8Array, StreamError>>,
				) => void;
				"[method]input-stream.blocking-read": (
					self: i32,
					len: i64,
		...
		export namespace OutputStream {
			export type WasmInterface = {
				...
				"[method]output-stream.write": (
					...
					contents_ptr: i32,
					contents_len: i32,
					result: ptr<result<void, StreamError>>,
				) => void;
				"[method]output-stream.blocking-write-and-flush": (
					self: i32,
					contents_ptr: i32,
