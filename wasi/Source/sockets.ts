...
export namespace sockets {
	export namespace Network.$ {
		export const Network = new $wcm.ResourceType<sockets.Network.Network>(
			"network",
		...
		export const IpSocketAddress = new $wcm.VariantType<
			...
			sockets.Network.IpSocketAddress._vt
		>(
			[
	...
	export namespace IpNameLookup.$ {
		...
		ResolveAddressStream.addMethod(
			"resolveNextAddress",
			new $wcm.MethodType<
				sockets.IpNameLookup.ResolveAddressStream.Interface["resolveNextAddress"]
			>(
				"[method]resolve-address-stream.resolve-next-address",
				[],
				new $wcm.ResultType<
					sockets.IpNameLookup.IpAddress | undefined,
					sockets.IpNameLookup.ErrorCode
				>(
					new $wcm.OptionType<sockets.IpNameLookup.IpAddress>(
						IpAddress,
					),
					ErrorCode,
				),
		...
		ResolveAddressStream.addMethod(
			"subscribe",
			new $wcm.MethodType<
				sockets.IpNameLookup.ResolveAddressStream.Interface["subscribe"]
			>(
		...
		export const resolveAddresses =
			new $wcm.FunctionType<sockets.IpNameLookup.resolveAddresses>(
				...
				[
					[
						"network",
						new $wcm.BorrowType<sockets.IpNameLookup.Network>(
							Network,
						),
					],
					["name", $wcm.wstring],
				...
				new $wcm.ResultType<
					sockets.IpNameLookup.ResolveAddressStream,
					sockets.IpNameLookup.ErrorCode
				>(
					new $wcm.OwnType<sockets.IpNameLookup.ResolveAddressStream>(
						ResolveAddressStream,
					),
					ErrorCode,
				),
	...
	export namespace IpNameLookup._ {
		...
		export namespace ResolveAddressStream {
			export type WasmInterface = {
				"[method]resolve-address-stream.resolve-next-address": (
					self: i32,
					result: ptr<result<IpAddress | undefined, ErrorCode>>,
				) => void;
			...
			export namespace exports {
				export type WasmInterface =
					ResolveAddressStream.WasmInterface & {
						"[dtor]resolve-address-stream": (self: i32) => void;
					};
			}
		}
		...
		export namespace exports {
			...
			export namespace imports {
				export type WasmInterface = {
					...
					"[resource-rep]resolve-address-stream": (
						handle: i32,
					) => i32;
					"[resource-drop]resolve-address-stream": (
						handle: i32,
	...
	export namespace Tcp.$ {
		...
		TcpSocket.addMethod(
			...
			new $wcm.MethodType<sockets.Tcp.TcpSocket.Interface["startBind"]>(
				...
				[
					[
						"network",
						new $wcm.BorrowType<sockets.Tcp.Network>(Network),
					],
					["localAddress", IpSocketAddress],
				],
				new $wcm.ResultType<void, sockets.Tcp.ErrorCode>(
					undefined,
					ErrorCode,
				),
			),
		...
		TcpSocket.addMethod(
			"startConnect",
			new $wcm.MethodType<
				sockets.Tcp.TcpSocket.Interface["startConnect"]
			>(
		...
		TcpSocket.addMethod(
			"finishConnect",
			new $wcm.MethodType<
				sockets.Tcp.TcpSocket.Interface["finishConnect"]
			>(
				"[method]tcp-socket.finish-connect",
				[],
				new $wcm.ResultType<
					[sockets.Tcp.InputStream, sockets.Tcp.OutputStream],
					sockets.Tcp.ErrorCode
				>(
					new $wcm.TupleType<
						[sockets.Tcp.InputStream, sockets.Tcp.OutputStream]
					>([
						new $wcm.OwnType<sockets.Tcp.InputStream>(InputStream),
						new $wcm.OwnType<sockets.Tcp.OutputStream>(
							OutputStream,
						),
					]),
					ErrorCode,
		...
		TcpSocket.addMethod(
			"finishListen",
			new $wcm.MethodType<
				sockets.Tcp.TcpSocket.Interface["finishListen"]
			>(
		...
		TcpSocket.addMethod(
			...
			new $wcm.MethodType<sockets.Tcp.TcpSocket.Interface["accept"]>(
				...
				>(
					...
					>([
						new $wcm.OwnType<sockets.Tcp.TcpSocket>(TcpSocket),
						new $wcm.OwnType<sockets.Tcp.InputStream>(InputStream),
						new $wcm.OwnType<sockets.Tcp.OutputStream>(
							OutputStream,
						),
		...
		TcpSocket.addMethod(
			"localAddress",
			new $wcm.MethodType<
				sockets.Tcp.TcpSocket.Interface["localAddress"]
			>(
				"[method]tcp-socket.local-address",
				[],
				new $wcm.ResultType<
					sockets.Tcp.IpSocketAddress,
					sockets.Tcp.ErrorCode
		...
		TcpSocket.addMethod(
			"remoteAddress",
			new $wcm.MethodType<
				sockets.Tcp.TcpSocket.Interface["remoteAddress"]
			>(
		...
		TcpSocket.addMethod(
			...
			new $wcm.MethodType<
				sockets.Tcp.TcpSocket.Interface["setListenBacklogSize"]
			>(
		...
		TcpSocket.addMethod(
			"keepAliveEnabled",
			new $wcm.MethodType<
				sockets.Tcp.TcpSocket.Interface["keepAliveEnabled"]
			>(
				"[method]tcp-socket.keep-alive-enabled",
				[],
				new $wcm.ResultType<boolean, sockets.Tcp.ErrorCode>(
					$wcm.bool,
					ErrorCode,
				),
			),
		...
		TcpSocket.addMethod(
			"setKeepAliveEnabled",
			new $wcm.MethodType<
				sockets.Tcp.TcpSocket.Interface["setKeepAliveEnabled"]
			>(
		...
		TcpSocket.addMethod(
			"keepAliveIdleTime",
			new $wcm.MethodType<
				sockets.Tcp.TcpSocket.Interface["keepAliveIdleTime"]
			>(
		...
		TcpSocket.addMethod(
			...
			new $wcm.MethodType<
				sockets.Tcp.TcpSocket.Interface["setKeepAliveIdleTime"]
			>(
		...
		TcpSocket.addMethod(
			"keepAliveInterval",
			new $wcm.MethodType<
				sockets.Tcp.TcpSocket.Interface["keepAliveInterval"]
			>(
		...
		TcpSocket.addMethod(
			...
			new $wcm.MethodType<
				sockets.Tcp.TcpSocket.Interface["setKeepAliveInterval"]
			>(
		...
		TcpSocket.addMethod(
			"keepAliveCount",
			new $wcm.MethodType<
				sockets.Tcp.TcpSocket.Interface["keepAliveCount"]
			>(
				"[method]tcp-socket.keep-alive-count",
				[],
				new $wcm.ResultType<u32, sockets.Tcp.ErrorCode>(
					$wcm.u32,
					ErrorCode,
				),
			),
		...
		TcpSocket.addMethod(
			"setKeepAliveCount",
			new $wcm.MethodType<
				sockets.Tcp.TcpSocket.Interface["setKeepAliveCount"]
			>(
		...
		TcpSocket.addMethod(
			...
			new $wcm.MethodType<sockets.Tcp.TcpSocket.Interface["hopLimit"]>(
				...
				[],
				new $wcm.ResultType<u8, sockets.Tcp.ErrorCode>(
					$wcm.u8,
					ErrorCode,
				),
			),
		...
		TcpSocket.addMethod(
			"receiveBufferSize",
			new $wcm.MethodType<
				sockets.Tcp.TcpSocket.Interface["receiveBufferSize"]
			>(
				"[method]tcp-socket.receive-buffer-size",
				[],
				new $wcm.ResultType<u64, sockets.Tcp.ErrorCode>(
					$wcm.u64,
					ErrorCode,
				),
			),
		...
		TcpSocket.addMethod(
			...
			new $wcm.MethodType<
				sockets.Tcp.TcpSocket.Interface["setReceiveBufferSize"]
			>(
		...
		TcpSocket.addMethod(
			"sendBufferSize",
			new $wcm.MethodType<
				sockets.Tcp.TcpSocket.Interface["sendBufferSize"]
			>(
		...
		TcpSocket.addMethod(
			"setSendBufferSize",
			new $wcm.MethodType<
				sockets.Tcp.TcpSocket.Interface["setSendBufferSize"]
			>(
		...
		export namespace TcpSocket {
			export type WasmInterface = {
				"[method]tcp-socket.start-bind": (
					self: i32,
					network: i32,
					localAddress_IpSocketAddress_case: i32,
					localAddress_IpSocketAddress_0: i32,
					localAddress_IpSocketAddress_1: i32,
					localAddress_IpSocketAddress_2: i32,
					localAddress_IpSocketAddress_3: i32,
					localAddress_IpSocketAddress_4: i32,
					localAddress_IpSocketAddress_5: i32,
					localAddress_IpSocketAddress_6: i32,
					localAddress_IpSocketAddress_7: i32,
					localAddress_IpSocketAddress_8: i32,
					localAddress_IpSocketAddress_9: i32,
					localAddress_IpSocketAddress_10: i32,
				...
				"[method]tcp-socket.start-connect": (
					self: i32,
					network: i32,
					remoteAddress_IpSocketAddress_case: i32,
					remoteAddress_IpSocketAddress_0: i32,
					remoteAddress_IpSocketAddress_1: i32,
					remoteAddress_IpSocketAddress_2: i32,
					remoteAddress_IpSocketAddress_3: i32,
					remoteAddress_IpSocketAddress_4: i32,
					remoteAddress_IpSocketAddress_5: i32,
					remoteAddress_IpSocketAddress_6: i32,
					remoteAddress_IpSocketAddress_7: i32,
					remoteAddress_IpSocketAddress_8: i32,
					remoteAddress_IpSocketAddress_9: i32,
					remoteAddress_IpSocketAddress_10: i32,
					result: ptr<result<void, ErrorCode>>,
				) => void;
				"[method]tcp-socket.finish-connect": (
					self: i32,
					result: ptr<result<[InputStream, OutputStream], ErrorCode>>,
				) => void;
				"[method]tcp-socket.start-listen": (
					self: i32,
					result: ptr<result<void, ErrorCode>>,
				...
				"[method]tcp-socket.local-address": (
					self: i32,
					result: ptr<result<IpSocketAddress, ErrorCode>>,
				) => void;
				"[method]tcp-socket.remote-address": (
					self: i32,
					result: ptr<result<IpSocketAddress, ErrorCode>>,
				...
				"[method]tcp-socket.keep-alive-enabled": (
					self: i32,
					result: ptr<result<boolean, ErrorCode>>,
				) => void;
				"[method]tcp-socket.set-keep-alive-enabled": (
					self: i32,
					value: i32,
				...
				"[method]tcp-socket.keep-alive-idle-time": (
					self: i32,
					result: ptr<result<Duration, ErrorCode>>,
				) => void;
				"[method]tcp-socket.set-keep-alive-idle-time": (
					self: i32,
					value_Duration: i64,
				...
				"[method]tcp-socket.hop-limit": (
					self: i32,
					result: ptr<result<u8, ErrorCode>>,
				) => void;
				"[method]tcp-socket.set-hop-limit": (
					self: i32,
					value: i32,
				...
				"[method]tcp-socket.receive-buffer-size": (
					self: i32,
					result: ptr<result<u64, ErrorCode>>,
				) => void;
				"[method]tcp-socket.set-receive-buffer-size": (
					self: i32,
					value: i64,
	...
	export namespace TcpCreateSocket.$ {
		...
		export const createTcpSocket =
			new $wcm.FunctionType<sockets.TcpCreateSocket.createTcpSocket>(
				...
				[["addressFamily", IpAddressFamily]],
				new $wcm.ResultType<
					sockets.TcpCreateSocket.TcpSocket,
					sockets.TcpCreateSocket.ErrorCode
				>(
					new $wcm.OwnType<sockets.TcpCreateSocket.TcpSocket>(
						TcpSocket,
					),
					ErrorCode,
				),
	...
	export namespace Udp.$ {
		...
		export const OutgoingDatagram =
			new $wcm.RecordType<sockets.Udp.OutgoingDatagram>([
				...
				[
					"remoteAddress",
					new $wcm.OptionType<sockets.Udp.IpSocketAddress>(
						IpSocketAddress,
					),
				],
			]);
		...
		UdpSocket.addMethod(
			...
			new $wcm.MethodType<sockets.Udp.UdpSocket.Interface["startBind"]>(
				...
				[
					[
						"network",
						new $wcm.BorrowType<sockets.Udp.Network>(Network),
					],
					["localAddress", IpSocketAddress],
				],
				new $wcm.ResultType<void, sockets.Udp.ErrorCode>(
					undefined,
					ErrorCode,
				),
			),
		...
		UdpSocket.addMethod(
			...
			new $wcm.MethodType<sockets.Udp.UdpSocket.Interface["stream"]>(
				...
				>(
					...
					>([
						new $wcm.OwnType<sockets.Udp.IncomingDatagramStream>(
							IncomingDatagramStream,
						),
						new $wcm.OwnType<sockets.Udp.OutgoingDatagramStream>(
		...
		UdpSocket.addMethod(
			"localAddress",
			new $wcm.MethodType<
				sockets.Udp.UdpSocket.Interface["localAddress"]
			>(
		...
		UdpSocket.addMethod(
			"remoteAddress",
			new $wcm.MethodType<
				sockets.Udp.UdpSocket.Interface["remoteAddress"]
			>(
		...
		UdpSocket.addMethod(
			"unicastHopLimit",
			new $wcm.MethodType<
				sockets.Udp.UdpSocket.Interface["unicastHopLimit"]
			>(
				"[method]udp-socket.unicast-hop-limit",
				[],
				new $wcm.ResultType<u8, sockets.Udp.ErrorCode>(
					$wcm.u8,
					ErrorCode,
				),
			),
		...
		UdpSocket.addMethod(
			"setUnicastHopLimit",
			new $wcm.MethodType<
				sockets.Udp.UdpSocket.Interface["setUnicastHopLimit"]
			>(
		...
		UdpSocket.addMethod(
			"receiveBufferSize",
			new $wcm.MethodType<
				sockets.Udp.UdpSocket.Interface["receiveBufferSize"]
			>(
				"[method]udp-socket.receive-buffer-size",
				[],
				new $wcm.ResultType<u64, sockets.Udp.ErrorCode>(
					$wcm.u64,
					ErrorCode,
				),
			),
		...
		UdpSocket.addMethod(
			"setReceiveBufferSize",
			new $wcm.MethodType<
				sockets.Udp.UdpSocket.Interface["setReceiveBufferSize"]
			>(
		...
		UdpSocket.addMethod(
			"sendBufferSize",
			new $wcm.MethodType<
				sockets.Udp.UdpSocket.Interface["sendBufferSize"]
			>(
		...
		UdpSocket.addMethod(
			"setSendBufferSize",
			new $wcm.MethodType<
				sockets.Udp.UdpSocket.Interface["setSendBufferSize"]
			>(
		...
		IncomingDatagramStream.addMethod(
			"receive",
			new $wcm.MethodType<
				sockets.Udp.IncomingDatagramStream.Interface["receive"]
			>(
				"[method]incoming-datagram-stream.receive",
				[["maxResults", $wcm.u64]],
				new $wcm.ResultType<
					sockets.Udp.IncomingDatagram[],
					sockets.Udp.ErrorCode
				>(
					new $wcm.ListType<sockets.Udp.IncomingDatagram>(
						IncomingDatagram,
					),
					ErrorCode,
				),
		...
		IncomingDatagramStream.addMethod(
			"subscribe",
			new $wcm.MethodType<
				sockets.Udp.IncomingDatagramStream.Interface["subscribe"]
			>(
		...
		OutgoingDatagramStream.addMethod(
			"checkSend",
			new $wcm.MethodType<
				sockets.Udp.OutgoingDatagramStream.Interface["checkSend"]
			>(
		...
		OutgoingDatagramStream.addMethod(
			"send",
			new $wcm.MethodType<
				sockets.Udp.OutgoingDatagramStream.Interface["send"]
			>(
				"[method]outgoing-datagram-stream.send",
				[
					[
						"datagrams",
						new $wcm.ListType<sockets.Udp.OutgoingDatagram>(
							OutgoingDatagram,
						),
					],
				],
		...
		OutgoingDatagramStream.addMethod(
			"subscribe",
			new $wcm.MethodType<
				sockets.Udp.OutgoingDatagramStream.Interface["subscribe"]
			>(
	...
	export namespace Udp._ {
		...
		export namespace UdpSocket {
			export type WasmInterface = {
				...
				"[method]udp-socket.stream": (
					self: i32,
					remoteAddress_case: i32,
					remoteAddress_option_IpSocketAddress_case: i32,
					remoteAddress_option_IpSocketAddress_0: i32,
					remoteAddress_option_IpSocketAddress_1: i32,
					remoteAddress_option_IpSocketAddress_2: i32,
					remoteAddress_option_IpSocketAddress_3: i32,
					remoteAddress_option_IpSocketAddress_4: i32,
					remoteAddress_option_IpSocketAddress_5: i32,
					remoteAddress_option_IpSocketAddress_6: i32,
					remoteAddress_option_IpSocketAddress_7: i32,
					remoteAddress_option_IpSocketAddress_8: i32,
					remoteAddress_option_IpSocketAddress_9: i32,
					remoteAddress_option_IpSocketAddress_10: i32,
					result: ptr<
						result<
							[IncomingDatagramStream, OutgoingDatagramStream],
							ErrorCode
		...
		export namespace IncomingDatagramStream {
			export type WasmInterface = {
				"[method]incoming-datagram-stream.receive": (
					self: i32,
					maxResults: i64,
					result: ptr<result<IncomingDatagram[], ErrorCode>>,
				) => void;
				"[method]incoming-datagram-stream.subscribe": (
					self: i32,
				) => i32;
			...
			export namespace exports {
				export type WasmInterface =
					IncomingDatagramStream.WasmInterface & {
						"[dtor]incoming-datagram-stream": (self: i32) => void;
					};
			}
		}
		...
		export namespace OutgoingDatagramStream {
			...
			export namespace exports {
				export type WasmInterface =
					OutgoingDatagramStream.WasmInterface & {
						"[dtor]outgoing-datagram-stream": (self: i32) => void;
					};
			}
		}
		...
		export namespace exports {
			...
			export namespace imports {
				export type WasmInterface = {
					...
					"[resource-rep]incoming-datagram-stream": (
						handle: i32,
					) => i32;
					"[resource-drop]incoming-datagram-stream": (
						handle: i32,
					...
					"[resource-rep]outgoing-datagram-stream": (
						handle: i32,
					) => i32;
					"[resource-drop]outgoing-datagram-stream": (
						handle: i32,
	...
	export namespace UdpCreateSocket.$ {
		...
		export const createUdpSocket =
			new $wcm.FunctionType<sockets.UdpCreateSocket.createUdpSocket>(
				...
				[["addressFamily", IpAddressFamily]],
				new $wcm.ResultType<
					sockets.UdpCreateSocket.UdpSocket,
					sockets.UdpCreateSocket.ErrorCode
				>(
					new $wcm.OwnType<sockets.UdpCreateSocket.UdpSocket>(
						UdpSocket,
					),
					ErrorCode,
				),
