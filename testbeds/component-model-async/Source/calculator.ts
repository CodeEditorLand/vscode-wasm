...
export namespace ReverseNotation.$ {
	export const Operation = new $wcm.EnumType<ReverseNotation.Operation>([
		"add",
		"sub",
		"mul",
		"div",
...
export namespace calculator._ {
	...
	export type Exports = {
		...
		"vscode:example/reverse-notation#[method]engine.push-operand": (
			self: i32,
			operand: i32,
		) => void;
		"vscode:example/reverse-notation#[method]engine.push-operation": (
			self: i32,
			operation_Operation: i32,
		) => void;
		"vscode:example/reverse-notation#[method]engine.execute": (
			self: i32,
		) => i32;
	};
