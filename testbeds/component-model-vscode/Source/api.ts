...
export namespace api {
	...
	export namespace Callbacks._ {
		...
		export type WasmInterface = {
			"did-change-text-document": (
				...
				event_TextDocumentChangeEvent_contentChanges_ptr: i32,
				event_TextDocumentChangeEvent_contentChanges_len: i32,
				event_TextDocumentChangeEvent_reason_case: i32,
				event_TextDocumentChangeEvent_reason_option_TextDocumentChangeReason: i32,
			) => void;
	...
	export namespace all._ {
		...
		export type Exports = {
			"activate": () => void;
			"deactivate": () => void;
			"host:api/callbacks#did-change-text-document": (
				event_TextDocumentChangeEvent_document: i32,
				event_TextDocumentChangeEvent_contentChanges_ptr: i32,
				event_TextDocumentChangeEvent_contentChanges_len: i32,
				event_TextDocumentChangeEvent_reason_case: i32,
