...
export namespace Notification {
	export function is(value: any): value is Notification {
		...
		return (
			...
			candidate !== null &&
			typeof candidate.method === "string" &&
			typeof (candidate as Request).id === "undefined"
		);
	}
}
...
export type ResultType =
	| NoResult
	| TypedArrayResult
	| VariableResult<object | TypedArray>;
namespace ResultType {
	export function is(value: any): value is ResultType {
		return (
			value instanceof Uint8Result ||
			value instanceof Int8Result ||
			value instanceof Uint16Result ||
			value instanceof Int16Result ||
			value instanceof Uint32Result ||
			value instanceof Int32Result ||
			value instanceof Uint64Result ||
			value instanceof Int64Result ||
			value instanceof VariableResult ||
...
type SendRequestSignatures<Requests extends RequestType | undefined> = [
	Requests,
] extends [RequestType]
	? _SendRequestSignatures<Requests>
	: undefined;
...
export abstract class BaseClientConnection<
	Requests extends RequestType | undefined = undefined,
	ReadyParams extends Params | undefined = undefined,
> implements ClientConnection<Requests, ReadyParams>
{
	...
	public readonly sendRequest: SendRequestSignatures<Requests> = this
		._sendRequest as SendRequestSignatures<Requests>;
...
type _HandleRequestSignatures<Requests extends RequestType> =
	UnionToIntersection<
		{
			[R in Requests as R["method"]]: R["params"] extends null | undefined
				? R["result"] extends null | undefined
				...
				? (
						...
						handler: (
							params: R["params"]
						) => { errno: RPCErrno } | Promise<{ errno: RPCErrno }>
				  ) => Disposable
				: R["result"] extends TypedArray
				? (
						method: R["method"],
...
type HandleRequestSignatures<Requests extends RequestType | undefined> = [
	Requests,
] extends [RequestType]
...
export abstract class BaseServiceConnection<
	RequestHandlers extends RequestType | undefined = undefined,
	ReadyParams extends Params | undefined = undefined,
